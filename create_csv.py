...
def create_csv():
    ...
    data = []
    for genre in os.listdir("posters"):
        for image in os.listdir(f"posters/{genre}"):
...
def combine_rows():
    # Read the CSV file
    with open("movie_dataset.csv", "r") as file:
    ...
    with open("movie_dataset_combined.csv", "w") as file:
